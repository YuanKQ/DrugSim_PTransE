...
public:
    ...
    void run()
    {
        ...
        //cout<<"fb_l.size:"<<fb_l.size()<<" a_len_one: "<<a_len_one<<" predict_false_ddi_num: "<<predict_false_ddi_num<<" predict_ddi_num: "<<predict_ddi_num<<" predict_other_num: "<<predict_other_num<<endl;
    }
};
Test test;
